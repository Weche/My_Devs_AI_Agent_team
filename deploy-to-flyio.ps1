...
if ($volumeExists) {
    ...
    Write-Host "Creating 1GB volume in São Paulo (database only, workspaces use GitHub)..." -ForegroundColor Gray
    flyctl volumes create albedo_data --size 1 --region gru -a albedo-ai-team
